...
data:
  ...
  bundledCode: "#define PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_path_sum\"\
    ...
    \ To support forest, just change \n * init to take in a vector of roots, and DFS\
  ...
  verifiedWith: []
documentation_of: test/heavy-light-decomposition.test.cpp
layout: document
redirect_from:
- /verify/test/heavy-light-decomposition.test.cpp
- /verify/test/heavy-light-decomposition.test.cpp.html
